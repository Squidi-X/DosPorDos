...
/DDoS Attack Script With No Method LoL!! /
/Please dont attack ISIS and Human -chars/
 ...
 * Discord : Packme#4527
 * [GitHub][github]
#### Like the project? Dont Leave a ⭐ star on the repository!

## Downloads

You can download from [GitHub Releases](https://github.com/Squidi-X/DosPosDos/releases)
...
```console
git clone https://github.com/Squidi-X/DosPorDos.git
cd DosPorDos
...
```console
python3 start.py
python3 start.py bypass https://bahala-ka-sa-website-namo.com 5 1000 socks5.txt 100 100
```

[python3]: https://python.org 'Python3'
[github]: https://github.com/Squidi-X/DosPorDos/issues 'GitHub'
